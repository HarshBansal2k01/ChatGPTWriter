    ...
    <>
      ...
      <div className="pl-[30px] pr-[30px] ">
        ...
        <p className="text-sm text-center">
          ...
          faster and more effectively. It uses AI to suggest text as you write,
          so you can spend less time typing and more time on what matters.
        </p>
        <div className="mt-4 flex justify-center items-center">
          <button className="bg-yellow-300 text-white pb-[6px] pt-[6px] w-52 rounded-md hover:bg-slate-950">
            Get Started
          </button>
        </div>
      </div>
